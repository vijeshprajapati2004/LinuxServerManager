...
import 'package:lsm/presentation/screens/about/upi_donation_screen.dart';
  ...
  void _showLicenseDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'LSM is licensed under the GNU General Public License v3.0 or later.\n\n'
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    // App Name
                    Text('LSM', style: theme.textTheme.headlineMedium),
                ...
                child: Row(
                  ...
                  children: [
                    _buildGlassPill(
                      ...
                      onTap: () => _launchUrl('https://github.com/prathameshkhade/lsm/issues'),
                    ),
                ...
                child: Row(
                  children: [
                    _buildGlassPill(
                      ...
                      onTap: () =>
                          _launchUrl('https://github.com/prathameshkhade/lsm/discussions'),
                    ),
                    const SizedBox(width: 8),
                    _buildGlassPill(
                      title: 'Wiki',
                      icon: Icons.menu_book_outlined,
                      onTap: () => _launchUrl('https://github.com/prathameshkhade/lsm/wiki'),
                    ),
                  ],
                ),
              ),
              ...
              const Text(
                'LSM is an open-source mobile application designed to simplify Linux server management via SSH, providing a GUI-driven experience for system administrators. With features like SSH Manager, File Explorer, Scheduled Jobs, Live Resource Monitoring, Terminal Access, and Environment Variable Management.',
